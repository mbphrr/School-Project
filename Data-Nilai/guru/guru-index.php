     ...
     <hr>
        ...
        <div class="container">
            ...
            <div class="tabel mt-lg-5">
                    ...
                    <a class="btn btn-warning text-dark" href="../tambah-data-guru/tambah-siswa-guru.php" role="button"><span> Tambah data</span></a>
                    </div>
    ...
    <section id="nilai" class="Nilai">
      <div class="container">
        ...
        <div class="tabel mt-lg-5">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                    <a class="btn btn-warning text-dark" href="../tambah-data-guru/tambah-nilai-guru.php" role="button"><span> Tambah data</span></a>
                    </div>
