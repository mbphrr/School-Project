...
<?php
                ...
                if( addsiswa($_POST) > 0){
                    echo  "<script>
                                ...
                                document.location.href = '../guru/guru-index.php?#dasis';
                            </script>
                        ";
                }else{
                    echo  "<script>
...
?>
                ...
                <div class="col-md-6">
                <label for="
                tanggallahir" class="form-label">TANGGAL LAHIR :</label>
                <input type="text" class="form-control" name="tanggallahir" id="tanggallahir"required>
                </div>
