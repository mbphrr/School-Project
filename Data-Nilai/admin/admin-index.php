            ...
            <div class="tabel mt-lg-5">
                            <table class="table table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="icon text-center text-dark" ><a href="../edit-data/edit-siswa.php?nisn=<?=$data['nisn'];?>" class="text-dark"><i class="fa-solid fa-pen-to-square p-2"></i></a>/<a href="../hapus-data/hapus-siswa.php?id=<?=$data['nisn'];?>" class="text-dark"><i class="fa-solid fa-trash p-2"></i></a></td>
                                </tr>                                                                           
                                <?php } ?>
                                </tbody>
                        </table>
                    ...
                    <a class="btn btn-warning text-dark" href="../tambah-data/tambah-siswa.php" role="button"><span> Tambah data</span></a>
                    </div>
        ...
        <div class="tabel mt-lg-5">
                            <table class="table table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="icon text-center text-dark" ><a href="../edit-data/edit-nilai.php?id=<?=$data['id'];?>" class="text-dark"><i class="fa-solid fa-pen-to-square p-2"></i></a>/<a href="../hapus-data/hapus-nilai.php?id=<?=$data['id'];?>" class="text-dark"><i class="fa-solid fa-trash p-2"></i></a></td>
                                </tr>
                                <?php } ?>
                                </tbody>
                        </table>
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                    <a class="btn btn-warning text-dark" href="../tambah-data/tambah-nilai.php" role="button"><span> Tambah data</span></a>
                    </div>
        ...
        <div class="tabel mt-lg-5">
                            <table class="table table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="icon text-center text-dark" ><a href="../edit-data/edit-guru.php?nip=<?=$data['nip'];?>" class="text-dark"><i class="fa-solid fa-pen-to-square p-2"></i></a>/<a href="../hapus-data/hapus-guru.php?id=<?=$data['nip'];?>" class="text-dark"><i class="fa-solid fa-trash p-2"></i></a></td>
                                </tr>
                                <?php } ?>
                                </tbody>
                        </table>
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                    <a class="btn btn-warning text-dark" href="../tambah-data/tambah-guru.php" role="button"><span> Tambah data</span></a>
                    </div>
